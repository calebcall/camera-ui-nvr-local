...
func TestDetectionEventIngester_Handle_UpsertsTheEvent(t *testing.T) {
	fake := &fakeEventStore{}
	ingester := newDetectionEventIngester(fake, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestDetectionEventIngester_Handle_CallsMarkEventOnRegisteredRecorder(t *testing.T) {
	...
	ingester := newDetectionEventIngester(&fakeEventStore{}, lookup, nil, nil, nil, nil, nil, nil, nil)
...
func TestDetectionEventIngester_Handle_SetsHasRecordingWhenCovered(t *testing.T) {
	...
	ingester := newDetectionEventIngester(fake, nil, nil, coverage, nil, nil, nil, nil, nil)
...
func TestDetectionEventIngester_Handle_ActiveRecordingSetsHasRecordingWithoutCoverage(t *testing.T) {
	...
	ingester := newDetectionEventIngester(fake, lookup, nil, coverage, nil, nil, nil, nil, nil)
...
func TestDetectionEventIngester_Handle_RealSegmentStore_LinksHasRecordingEndToEnd(t *testing.T) {
	...
	ingester := newDetectionEventIngester(p.events, nil, nil, p.segments, nil, nil, nil, nil, nil)
...
func TestDetectionEventIngester_Describe_ForwardsMergedEventOnEveryMessage(t *testing.T) {
	spy := &spyDescriber{}
	ingester := newDetectionEventIngester(&fakeEventStore{}, nil, nil, nil, nil, nil, spy, nil, nil)
